...
import productos.ProductoSeleccionado;
import productos.hamburguesas;

/**
 *
 * @author Ana
 */
public class PantallaPrinE extends javax.swing.JFrame {

private Map<String, ProductoSeleccionado> carrito = new HashMap<>();
    public PantallaPrinE() {
        initComponents();
        ...
        jMenu5 = new JMenu();
        jMenu5.setIcon(new ImageIcon("C:\\Users\\Ana\\Documents\\NetBeansProjects\\libreria\\LoginForm\\src\\Empleado\\im.png"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            PantallaPrinE frame = new PantallaPrinE();
